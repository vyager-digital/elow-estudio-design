...
// ../../../.wrangler/tmp/pages-JG9jKh/functionsWorker-0.9682907171313486.mjs
...
var CATS = ["identidade-visual", "naming", "redesign-de-marca"];
var MAX_GALLERY = 14;
var MAX_IMG_B64 = 85e5;
...
async function handlePublish({ request, env }) {
  ...
  try {
    ...
    return json(400, { error: "Requisi\xE7\xE3o inv\xE1lida." });
  }
  ...
  if (!CATS.includes(cat)) return json(400, { error: "Categoria inv\xE1lida." });
  ...
  for (const img of [cover, ...gallery]) {
    if (typeof img !== "string" || !B64_RE.test(img)) return json(400, { error: "Imagem em formato inv\xE1lido." });
    if (img.length > MAX_IMG_B64) return json(400, { error: "Uma das imagens \xE9 grande demais (m\xE1x. 6 MB ap\xF3s convers\xE3o)." });
  }
...
// .wrangler/tmp/bundle-H6DN56/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-H6DN56/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9682907171313486.js.map
